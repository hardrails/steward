...
description: Exact operating-system, architecture, packaging, Docker, gVisor, and development support for Steward v1.3.
section: Reference
---
...
| Alpine/OpenRC and non-systemd Linux | — | — | Not supported in v1.3 |
...
| Windows | No v1.3 artifact | No | No |
