...
var controlContextCommands = map[string]controlContextCommandSpec{
	...
	"node-pool list":            {network: true, token: true},
	"node-pool status":          {network: true, token: true},
	"node-pool apply":           {network: true, token: true},
	"node-pool delete":          {network: true, token: true},
	"node-pool membership-bind": {network: true},
	"node-credential revoke":    {network: true, token: true},
	"operations status":         {network: true, token: true, tenant: true},
	"quota status":              {network: true, token: true, tenant: true},
	"quota set":                 {network: true, token: true, tenant: true},
	"quota clear":               {network: true, token: true, tenant: true},
