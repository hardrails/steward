...
var completionTree = map[string][]string{
	...
	"executor-command delegation": {"issue", "verify"},
	"control":                     {"pki", "tenant", "operator", "enrollment", "node", "node-credential", "operations", "quota", "freeze", "attention", "agent", "command", "credential", "evidence", "evidence-capture", "support-bundle"},
	"control pki":                 {"create"},
