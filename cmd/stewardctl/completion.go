...
var completionTree = map[string][]string{
	...
	"executor-command delegation": {"issue", "verify"},
	"control":                     {"pki", "backup", "tenant", "operator", "enrollment", "node", "node-pool", "node-credential", "snapshot", "operations", "quota", "freeze", "attention", "incident", "agent", "event", "task", "command", "credential", "evidence", "evidence-capture", "support-bundle"},
