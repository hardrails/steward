...
description: Exact operating-system, architecture, packaging, Docker, gVisor, and development support for Steward v1.2.
section: Reference
---
...
| Alpine/OpenRC and non-systemd Linux | — | — | Not supported in v1.2 |
...
| Windows | No v1.2 artifact | No | No |
