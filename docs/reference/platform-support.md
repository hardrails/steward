...
description: Exact operating-system, architecture, packaging, Docker, gVisor, and development support for Steward v1.4.
section: Reference
---
...
| Alpine/OpenRC and non-systemd Linux | — | — | Not supported in v1.4 |
...
| Windows | No v1.4 artifact | No | No |
