...
| Nodes | Node state, placement mode, durable drain state and request ID, last observation time, tenant bindings, and reported capabilities for one selected tenant | Node credentials and direct node actions |
