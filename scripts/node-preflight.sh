...
optional=' EXECUTOR_OPERATOR_TOKEN_FILE EXECUTOR_OBSERVER_TOKEN_FILE EXECUTOR_UPLINK_DELIVERY_STATE_FILE EXECUTOR_UPLINK_PROTOCOL_VERSION EXECUTOR_EVIDENCE_UPLINK_ENABLED EXECUTOR_EVIDENCE_UPLINK_CONTROLLER_INSTANCE_ID EXECUTOR_EVIDENCE_UPLINK_POLL_INTERVAL EXECUTOR_ADMISSION_POLICY_FILE EXECUTOR_ADMISSION_SITE_ROOT_PUBLIC_KEY_FILE EXECUTOR_ADMISSION_SITE_ROOT_KEY_ID EXECUTOR_ADMISSION_NODE_ID EXECUTOR_ADMISSION_EVIDENCE_KEY_FILE EXECUTOR_ADMISSION_HOST_ADMIN_ARG EXECUTOR_STATE_ARG EXECUTOR_MAX_TOTAL_MEMORY_BYTES EXECUTOR_MAX_TOTAL_CPU_MILLIS EXECUTOR_MAX_TOTAL_PIDS EXECUTOR_MAX_TENANT_MEMORY_BYTES EXECUTOR_MAX_TENANT_CPU_MILLIS EXECUTOR_MAX_TENANT_PIDS '
