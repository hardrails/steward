...
func (server *Server) routes() {
	...
	server.mux.HandleFunc("/v1/tenants/{tenant_id}/interactions/{interaction_id}", server.interaction)
	server.mux.HandleFunc("/v1/tenants/{tenant_id}/interactions/{interaction_id}/response", server.interactionResponse)
	...
	server.mux.HandleFunc("/executor-uplink/interactions", server.executorInteractions)
	server.mux.HandleFunc("/executor-uplink/interactions/responses/poll", server.executorInteractionResponsePoll)
	server.mux.HandleFunc("/executor-uplink/interactions/responses/ack", server.executorInteractionResponseAck)
