...
var commandHelp = map[string]string{
	...
	"control":          "Enroll nodes, manage scoped operators, freeze command delivery during incidents, place and drain agent workloads, inspect fleet evidence, and create metadata-only support bundles.\n\nUsage: stewardctl control pki|tenant|operator|enrollment|node|operations|freeze|attention|command|credential|evidence|support-bundle ...\n",
