...
var completionTree = map[string][]string{
	...
	"executor-command delegation": {"issue", "verify"},
	"control":                     {"pki", "tenant", "operator", "enrollment", "node", "node-credential", "snapshot", "operations", "quota", "freeze", "attention", "incident", "agent", "event", "task", "command", "credential", "evidence", "evidence-capture", "support-bundle"},
	"control pki":                 {"create"},
